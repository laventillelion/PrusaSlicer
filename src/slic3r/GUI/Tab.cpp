...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Support material"), "support");
        ...
        optgroup->append_single_option_line("raft_pattern_spacing", category_path + "raft-pattern-spacing");
        optgroup->append_single_option_line("first_raft_layer_height", category_path + "first-raft-layer-height");
